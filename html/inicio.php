...
?>
    <div class="container insertar">
        <div class="titulo">
            <h2 class="display-4">Importar</h2>
        </div>
        <div class="row csv ">
            <div class="col-6">
                <form enctype="multipart/form-data" action="php/csv.php" method="POST">
                    <fieldset>
                        <legend>Usuarios/Grupos</legend>
                        <input type="hidden" name="MAX_FILE_SIZE" value="512000" />
                        <p class="lead"> Enviar mi archivo: <input class="lead" name="subir_archivo" type="file" /></p>
                        <p> <input type="submit" class="btn btn-secondary value=" Enviar Archivo" /></p>
                    </fieldset>
                </form>
            </div>
            <div class="col-6">
                <form enctype="multipart/form-data" action="php/csvr.php" method="POST">
                    <fieldset>
    ...
    <div class="insertar container">
        <div class="titulo">
            <h2 class="display-4">Lista de usuarios conectados:</h2>
        </div>
        <div class="row">
